...
class SecondImageBlock extends SecondBlog {
  SecondImageBlock({required List<SecondBlogSpan> content, required String url})
  ...
  factory SecondImageBlock.fromJson(Map<String, dynamic> json) {
    final imageUrl = json['image']?['file']?['url'] ?? ''; // Modify this line
    return SecondImageBlock(content: [], url: imageUrl); // Modify this line
  }
